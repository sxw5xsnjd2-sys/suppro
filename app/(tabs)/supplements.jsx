...
export default function SupplementsScreen() {
    ...
    return (<Screen header={<Header title="Supplements" subtitle="What you’re currently taking" centered/>}>
      <View style={styles.section}>
        {isEmpty ? (<EmptyState />) : (<View style={styles.list}>
            {sorted.map((s) => (<SupplementCard key={s.id} name={s.name} subtitle={s.dose ? `${s.dose} · ${s.time}` : s.time} route={s.route} iconBackgroundColor={iconColorFor(s.catalogId)} showCheckbox={false} onInfoPress={() => router.push({
