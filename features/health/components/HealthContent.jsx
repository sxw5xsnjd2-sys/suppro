...
export function HealthContent({ requireSubscriptionAccess }) {
    ...
    <>
      ...
      {enabledMetrics.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Pressable
            accessibilityRole="button"
            accessibilityLabel="Pick health metrics to track"
            onPress={() => {
              if (!requireSubscriptionAccess("health_metrics")) {
                return;
              }
        ...
        <View style={styles.feed}>
          <View style={styles.sectionRow}>
            ...
            {IS_APPLE_HEALTH_SUPPORTED_PLATFORM ? (
              ...
              <Text style={styles.manualOnlyLabel}>Manual tracking</Text>
            )}
          </View>
