      ...
      <View style={styles.backdrop}>
        <View style={styles.card}>
          ...
          <View style={styles.field}>
            ...
            <TextInput value={metricName} onChangeText={setMetricName} placeholder="e.g. Focus, Anxiety, Pain" placeholderTextColor={colors.text.muted} style={styles.input}/>
          </View>
          ...
          <View style={styles.field}>
            ...
            <Slider minimumValue={1} maximumValue={10} step={1} value={value} onValueChange={setValue} minimumTrackTintColor={colors.brand.primary} maximumTrackTintColor={colors.border.subtle} thumbTintColor={colors.brand.primary}/>
          ...
          <Pressable onPress={handleSave} disabled={!metricName.trim()} style={({ pressed }) => [
            styles.saveButton,
