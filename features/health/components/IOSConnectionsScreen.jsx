...
export function IOSConnectionsScreen() {
  const {
    connection,
    connectionError,
    lastSyncedAt,
    ...
    <BackdropScreen
      header={
        <AppHeader
          ...
          bottomSlot={<Text style={styles.headerSubtitle}>Manage Apple Health</Text>}
      ...
      <PrimaryCard style={styles.appleHealthCard}>
          ...
          <View style={styles.appleHealthContent}>
            <View style={styles.appleHealthTitleRow}>
              ...
              <Switch
                ...
                disabled={isSyncing || !hasCheckedAppleHealthAvailability}
        ...
        connectionError === APPLE_HEALTH_NO_DATA_MESSAGE ? (
          <Text style={styles.appleHealthNote}>
            Follow this path on your iPhone: Settings &gt; Apple Health &gt; Suppro
            &gt; Turn On All.
          </Text>
        ) : null}
      </PrimaryCard>
