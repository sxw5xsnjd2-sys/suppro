...
set
  ...
  dose_scoring_profile_json = null
where name = 'Branched-Chain Amino Acids (BCAAs)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Black Currant Seed Oil (Ribes nigrum)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Black Seed Oil (Nigella sativa)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Chlorogenic Acid / Green Coffee Bean'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Coenzyme Q10 (CoQ10) / Ubiquinol'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Diindolylmethane (DIM)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Garcinia extract (hydroxycitric acid)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Gotu kola (Centella asiatica)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Green tea extract / EGCG'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Beta-hydroxy beta-methylbutyrate (HMB)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Oral hyaluronic acid'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Methylsulfonylmethane (MSM)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Neem Oil (Azadirachta indica)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Niacinamide / Nicotinamide / Niacin (Vitamin B3)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Nicotinamide mononucleotide (NMN)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Omega-3 fatty acids'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Sea Moss (Chondrus crispus)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Spirulina (Arthrospira platensis)'
  and status = 'approved';
...
set
  ...
  dose_scoring_profile_json = null
where name = 'Vitamin E (Tocopherols and Tocotrienols)'
  and status = 'approved';
